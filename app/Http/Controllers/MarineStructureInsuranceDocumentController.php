...
class MarineStructureInsuranceDocumentController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            // بناء الاستعلام
            $query = MarineStructureInsuranceDocument::with(['registrationAuthority.city', 'engines', 'branchAgent', 'user']);
    ...
    public function store(Request $request)
    {
        try {
            $validated = $request->validate([
                ...
                'registration_authority_id' => 'required|exists:plates,id',
                'plate_number' => 'required|string|max:255',
                'hull_number' => 'required|string|max:255',
                'manufacturing_material' => 'required|string|max:255',
                'length' => 'required|numeric|min:0',
                'width' => 'required|numeric|min:0',
                'depth' => 'required|numeric|min:0',
                'manufacturing_year' => 'required|integer|min:1960|max:2026',
                'manufacturing_country' => 'required|string|max:255',
                'color' => 'required|string|max:255',
                'fuel_tank_capacity' => 'required|numeric|min:0',
