...
<head>
    ...
    <title>تقرير إيرادات الوكيل - {{ $branchAgent->agency_name }}</title>
            ...
            <div class="company-info">
                ...
                <div class="document-title">
                    @if($type === 'monthly' && $year && $month)
                        ...
                        @endphp
                        تقرير إيرادات شهري للوكيل - {{ $monthName }} - {{ $month }}
                    @elseif($type === 'range' && !empty($fromDate) && !empty($toDate))
                        تقرير إيرادات الوكيل من {{ \Carbon\Carbon::parse($fromDate)->format('d/m/Y') }} إلى {{ \Carbon\Carbon::parse($toDate)->format('d/m/Y') }}
                    @else
                        تقرير إيرادات شامل للوكيل
                    @endif
                </div>
            </div>
            <div class="logo">
